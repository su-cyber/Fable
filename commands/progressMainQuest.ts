            ...
            if(err){
                ...
                if(res){
                    ...
                    if(foundUser.location == "Guild District"){
                        ...
                        await profileModel.updateOne({userID:interaction.user.id},{main_quest_phase:1,main_quest:"KS-ZS-MQ2",completed_quests:foundUser.completed_quests,guild:guild,guild_rank:"Unranked",ranger_grade:"E"})
                    }
                    else{
