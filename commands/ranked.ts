...
export default new MyCommandSlashBuilder({ name: 'ranked', description: 'Ranked battle for glory!' })
    
    .setDo(async (bot, interaction) => {

        const authorId = interaction.user.id
        let opponentId
        // interaction.reply({content:`This command is currently Restricted`,ephemeral:true})
