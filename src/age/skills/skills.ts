...
import Weaponskills from './weapon_skills'


const skills = flame_tree.concat(light_tree,gladius_tree,volt_tree,wave_tree,frost_tree,gale_tree,alloy_tree,bloom_tree,terra_tree,venom_tree,noir_tree,dragoon_tree,magus_tree,buushin_tree,Weaponskills)
